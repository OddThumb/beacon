/*
 *  This file is a derivative work of R: A Computer Language for Statistical Data Analysis
 *
 *  Original code Copyright (C) 1999-2016 The R Core Team
 *
